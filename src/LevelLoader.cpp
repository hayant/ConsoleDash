...
void LevelLoader::build_test_level(ConsoleDash& game) const {
    ...
    game.set_cell(25, 6, Tile::FIREFLY, static_cast<uint8_t>(Direction::LEFT));
    game.set_cell(24, 10, Tile::BUTTERFLY, static_cast<uint8_t>(Direction::UP));
